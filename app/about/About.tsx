...
const About = () => {
  return (
    <section>
      <h1 className="font-semibold text-2xl mb-4 tracking-tighter">About me</h1>
      <p className="mb-10">
      ...
      <h2 className="font-semibold text-xl mb-4 mt-2 tracking-tighter">
        About this page
      </h2>
      <p>
        ...
        <Link
          href="https://github.com/felix-wilberg/felix-wilberg"
          className="underline"
        >
          GitHub
        </Link>
